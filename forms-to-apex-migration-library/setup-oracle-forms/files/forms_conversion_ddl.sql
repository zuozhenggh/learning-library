...
CREATE USER orders IDENTIFIED BY Formstoapex2020;
GRANT create session TO orders;
GRANT create table TO orders;
GRANT create view TO orders;
GRANT create any trigger TO orders;
GRANT create any procedure TO orders;
GRANT create sequence TO orders;
GRANT create synonym TO orders;
grant connect to orders;
grant resource to orders;
alter user orders quota unlimited on users;

connect orders/Formstoapex2020
...
create or replace FUNCTION orders.GET_PRODUCT_IMAGE (product_number IN
