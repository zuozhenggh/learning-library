...
In this tutorial, you will add APM headers to the CORS policy in the API Gateway, which you created in the ToDo List Application Workshop, enable the APM Browser Agent to capture the frontend traces, and finally update the OCI Object Storage.
