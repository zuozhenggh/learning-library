# Lab 5: Advanced Session: Using REST API to Integrate AD service

## Introduction

Our anomaly detection services also support to use CLI tool `oci` or REST API calls to perform model and data operations. In this lab sessions, we will show several code snippets to integrate with our service endpoints.
...
### Prerequisites:
* Familiar with Python/Java programming is strongly recommended
* Familiar with local shell environments (cmd, bash, cshell, etc)
