...
## Task 1: Sign in to OCI Console create Object Storage Bucket and VCN
...
## Task 2: Create ssh keys, Create two Compute instances with OCI CLI pre installed
...
## Task 3: Upload API keys, and verify functionality
