...
## Task 2: Create ssh keys, two compute instances and install Redis
...
## Task 3: Configure Redis Master Slave mode
...
## Task 4: Configure Security Rules and verify deployment
