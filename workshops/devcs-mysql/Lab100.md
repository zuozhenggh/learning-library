...
### **Task $1: 1**: Verify your Oracle Cloud Trial Account
...
### **Task $1: 3**: Go to Compute Services and Create a Compartment
...
### **Task $1: 4**: Create a Virtual Compute Network
...
### **Task $1: 5**: Create the Developer Cloud Service Instance
...
### **Task $1: 7**: Import a GitHub repository, Create Key Pairs
...
### **Task $1: 7a Mac/Linux**: Create SSH Key Pairs (API and Instance) (Linux or Mac client)
...
### **Task $1: 7b Windows**: Create SSH Key Pair Create SSH Key Pairs (API and Instance) (Windows client)
...
### **Task $1: 8**: Copy Key pair contents into their respective files in the Git Repository
...
### **Task $1: 9**: Configure the DevCS connection to your OCI account
...
### **Task $1: 10**: Create Software Template and Virtual Machine configurations
...
### **Task $1: 11**: Edit the Packer "build.json" file
...
### **Task $1: 12**: Build the Packer job
...
### **Task $1: 13**: Edit the Terraform configuration file
...
### **Task $1: 14**: Edit the Terraform configuration file
...
### **Task $1: 15**: Build the Terraform job
...
### **Task $1: 16**: Build a Pipeline flow
...
### **Task $1: 17**: (**OPTIONAL**) Execute the Pipeline
...
### **Task $1: 18a**: SSH into the `MYSQL` Compute Instance (Windows)
...
### **Task $1: 18b**: SSH into the `MYSQL` Compute Instance (Linux/Mac)
...
### **Task $1: 19**: Verify the MYSQL, Git and Docker installations
