...
### Task 1: Preparing the WAR file to be Deployed
...
### Task 2: Uploading the war file to the  Application Container Cloud Service
...
### Task 2: Scale instance in the Application Container Cloud Service
