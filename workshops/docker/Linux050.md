...
## Task 1: Your Oracle Cloud Account
...
## Task 5: Add a Security List entry
...
## Task 6: Create SSH Key Pair (Linux or Mac client)
...
## Task 7: Create SSH Key Pair (Windows client)
...
## Task 8: Create a Compute Instance
...
## Task 10: Install and configure Docker and Git
...
## Task 11: Edit /etc/sysconfig/selinux
