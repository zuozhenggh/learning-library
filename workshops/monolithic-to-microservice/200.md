...
- Change the docker image name you care going to create in your job build.
  ...
  ![](images/200/img-4.png " ")

    

  ![](images/200/img-5.png " ")
...
3. Create a **Build Job**
    ...
    ***3.2. Creating User-catalog JAVA REST service docker container***
    ...
    2. Change the **ATP ocid, file names for the wallet zip file(in lines 1 and 4)**.
    ...
    4. Change the **secret yaml name** in the shell script.
