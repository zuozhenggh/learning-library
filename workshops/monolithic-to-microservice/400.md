...
## **Task $1: 1**: Configure Visual Builder Studio to create Mobile App
...
## **Task $1: 2**: Create Service Connections
...
## **Task $1: 3**: Import Mobile Application
...
## **Task $1: 4**: Configure Main page with all products information
...
## **Task $1: 5**: Configure details page to show product details
...
## **Task $1: 6**: Configure request more info page to submit product information request
...
## **Task $1: 8**: Save the app using Git
