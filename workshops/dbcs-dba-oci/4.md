...
## **Task $1: 2**:  Drop a Table 'Accidently'
...
## **Task $1: 4**:  Confirm Data Recovery
...
## **Task $1: 5**:  Collect Keys for use by the Oracle CLI
...
## **Task $1: 6**:  Configure the Oracle CLI
...
## **Task $1: 7**:  Run sample CLI commands.
