...
## **Task $1: 1**:  Log into your Oracle Cloud Account, Review the Console, and Create a Workshop Compartment
...
## **Task $1: 2**:  Create a Virtual Cloud Network (VCN)
...
## **Task $1: 3**:  Create a Marketplace Developer Cloud Image
...
## **Task $1: 4**:  Create Source and Target Database Cloud Service Instances
...
## **Task $1: 5**:  Import Data into DBCS source system `workshop1_db`.
...
## **Task $1: 6**:  Create an Object Storage Bucket to hold the zero down time backup files required in lab 2.
