...
### Task 5: Deploy Fn Server to Kubernetes Using Helm
...
### Task 6: Deploy Your Function to Fn Server on Kubernetes
...
### Task 7: Test Your Function in the Product Catalog
