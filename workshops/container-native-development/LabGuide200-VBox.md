...
### Task 4: Configure the OCI Terraform Kubernetes Installer
...
### Task 5: Provision Kubernetes on OCI
...
### Task 6: Define Kubernetes Deployment Specification
...
### Task 7: Define Wercker Deployment Pipelines
...
### Task 8: Set up deployment pipelines in Wercker
...
### Task 9: Set up environment variables in Wercker
...
### Task 10: Trigger a retry of the pipeline
...
### Task 12: Download the Product Catalog Kubernetes YAML file
...
### Task 13: Deploy and test the Product Catalog using the Kubernetes dashboard
