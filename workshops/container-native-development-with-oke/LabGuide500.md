...
## Task 1: Configure Cloud Shell to use Oracle Functions and Docker Registry(OCIR)
...
## Task 2: Deploy Fn Server to Kubernetes
...
## Task 3: Deploy Your Function to Fn Server on Kubernetes
...
## Task 4: Test Your Function in the Product Catalog
