...
### **Task $1: 1**: Create Build Job to Deploy SonarQube Docker Image in Compute Instance.
...
### **Task $1: 2**: Run the Build Job and Check Server Deployment
...
### **Task $1: 3**: Configure Developer Cloud Service to Use SonarQube
