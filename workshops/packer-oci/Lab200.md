...
### Task 2: Connect via SSH to the Instance
...
### Task 3: Install and configure Packer and GIT
...
### Task 5: Create public API key in .pem format
...
### Task 6: Gather OCIDs for Tenancy and Availability Domain
