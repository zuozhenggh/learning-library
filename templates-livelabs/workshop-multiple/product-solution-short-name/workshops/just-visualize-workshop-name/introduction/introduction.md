...
This introduction is for a "child" workshop. It is a subset of the "parent" workshop, and only covers a portion of the "parent" workshop. In this case, just enough to get customers to the Visualize lab.
