...
Last updated: 27-Jan-2022 by Kevin Lazarz
Version: 21.7.sprint (only to be used for LiveLab Sprints)
Feature: This version uses 'Expand All Sections' & 'Collapse All Sections' instead of 'Tasks', hotfix to display title when alt tag is used
*/
...
let main = function() {
    ...
    const expandText = "Expand All Sections";
    const collapseText = "Collapse All Sections";
