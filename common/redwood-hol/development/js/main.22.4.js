...
22.4        Mar-29-22       Ashwin Agarwal  Added fix for modal images not containing alt-text (LLAPEX-431)
*/
            ...
            $.get(tutorial.filename, function(markdownContent) { //reading MD file in the manifest and storing content in markdownContent variable
                ...
                do {
                    ...
                    if (matches !== null) {
                        ...
                        // LLAPPEX-400 Below part is not needed and fixes the accessibility bug
                        // $(ul).each(function() {
