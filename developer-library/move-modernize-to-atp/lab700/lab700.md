...
Seoul, S Korea: https://objectstorage.ap-seoul-1.oraclecloud.com/p/y3ska3lhIT2Bq48wLrnzXczpAEpEiWtu7oTVJjA5ID3QkbQDp2dO6C8i2aQcYKqN/n/oraclepartnersas/b/Lab-Material/o/soedump18C_1G.dmp

Note: You can use the Data Pump procedure for your own migration projects.
...
```
$ impdp admin/<password>@<My_ATP_high> directory=data_pump_dir credential=<credential name> schemas=soe dumpfile=https://objectstorage.ap-seoul-1.oraclecloud.com/p/y3ska3lhIT2Bq48wLrnzXczpAEpEiWtu7oTVJjA5ID3QkbQDp2dO6C8i2aQcYKqN/n/oraclepartnersas/b/Lab-Material/o/soedump18C_1G.dmp logfile=import.log parallel=2
```
