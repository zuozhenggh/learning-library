...
4. Use the following command to continuously tail the log of one of the PODss.
...
5. Create a **TodDolist deployment**.
...
8. Configure the routes by defining two routes:
