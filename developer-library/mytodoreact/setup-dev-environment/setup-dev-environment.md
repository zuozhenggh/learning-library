...
7.1. Stay in the mtdrwokshop/setup-dev-environment directory and launch sql with /nolog option.
...
7.2. Point the tool at your wallet.zip file
sql
   ```
...
7.3. Connect to mtdrdb\_tp service as database ADMIN user (remember the password given to ADMIN above).
...
7.4. Create TODOUSER with a strong password.
...
7.5. Grant some privileges to TODOUSER by executing the following command
