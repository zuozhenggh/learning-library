...
This 15-minute tutorial shows you how to create web pages to display the business objects you created in the previous tutorial, _Create a Web Application in Oracle Visual Builder_, and how to create new instances of the business objects.
