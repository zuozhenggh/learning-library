...
1. Run the `discover_domain.sh` script:
    ...
    [output of the discover_domain.sh script](https://raw.githubusercontent.com/streamnsight/learning-library/master/developer-library/weblogic-to-oci/workshops/weblogic-on-oci-mp/freetier/discover_domain.output.txt)
...
4. Run the `update_domain.sh` script:
  ...
  [View the output of the update_domain.sh script](https://raw.githubusercontent.com/streamnsight/learning-library/master/developer-library/weblogic-to-oci/workshops/weblogic-on-oci-mp/freetier/update_domain.output.txt)
