...
This lab walks you through provisioning the WebLogic infrastructure by leveraging the Oracle Cloud Marketplace image.
...
- Provision Oracle WebLogic Server on Oracle Cloud Infrastructure (WLS on OCI) via the Oracle Cloud Marketplace offering.
...
1. Go to **Solutions and Platforms**, select **Marketplace**, and then select **Applications**.
...
3. Make sure you are in the Compartment you want to use, use the default WebLogic version available, accept the license agreement and click **Launch Stack**.
...
6. Select a **Shape**.
  ...
  ![](./images/provision-7-shape.png)
   ...
   To check shape availability, you can go to **Governance** and select **Limits and Quotas** in another tab, and verify you have a specific shape available.
...
11. Check the check box for **WebLogic Server Advanced Server Configuration**. Here you can see all the default ports, which we will keep as-is.
...
26. The stack will get provisioned using the **Resource Manager**. This may take 7 to 15 minutes.

  ![](./images/provision-26.png)

Once the stack is provisioned, you can find the information regarding the URL and IP of the WebLogic Admin server in the logs, or in the **Outputs** left-side menu.

## **STEP 2:** Gather Deployment Information and Check the WebLogic Status
