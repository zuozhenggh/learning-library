...
1. Find all the customers within 100 miles of warehouse named 'Livonia Facility'
...
2. Find all the customers within 100 miles of warehouse named 'Livonia Facility', put the results in order of distance, and give the distance in miles.
...
3. Find all the customers inside a 30 min drive time polygons  
