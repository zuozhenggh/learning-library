...
```
cd $HOME
wget https://marcgueury.github.io/learning-library/developer-library/forms-to-oci/compile/files/DB_PASSWORDs.zip
unzip DB_PASSWORDs.zip
cd DB_PASSWORDs
