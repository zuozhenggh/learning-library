...
* Lab: [Create and auto-REST enable a table](../create-table/create-table.md)
* Lab: [Loading Data and Creating Business Objects](../load-data-and-biz-objs/load-data-and-biz-objs.md)
