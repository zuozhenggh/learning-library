sudo cp converged-wallet-jan2021.zip /home/oracle
sudo su - oracle
mkdir wallet
cd wallet
...
edit sqlnet.ora -> DIRECTORY - /home/oracle/wallet
conn admin/WElcome123##@cvgadb02_high

impdp admin/WElcome123##@cvgadb02_high directory=data_pump_dir credential=def_cred_name dumpfile=https://objectstorage.us-ashburn-1.oraclecloud.com/p/ys9d6Gwudj3xLkIV-987JY2Vlyr87G_x-z-uhsPGIYio228SPw3UPAawYVAYc0ou/n/idcd8c1uxhbm/b/converged-db/o/export_appgrph22Sep2020.dmp exclude=index, cluster, indextype, materialized_view, materialized_view_log, materialized_zonemap, db_link
...
sqlplus admin/WElcome123##@cvgadb02_high << EOF
