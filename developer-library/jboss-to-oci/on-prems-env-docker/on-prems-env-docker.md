...
You can also download the code [here](https://objectstorage.us-ashburn-1.oraclecloud.com/p/Ku2fmIyfei9z2vgqIArRp4D43LN5q731U6HyST8LLX5Rbq7QHB4L1ug754bphbZG/n/ocisateam/b/images/o/wildfly-to-oci.zip)
...
2. Unzip the files with:
    ...
    ```bash
    <copy>
    unzip JBoss/WildFly-to-oci.zip
    </copy>
    ```
...
1. Download the code [here](https://objectstorage.us-ashburn-1.oraclecloud.com/p/Ku2fmIyfei9z2vgqIArRp4D43LN5q731U6HyST8LLX5Rbq7QHB4L1ug754bphbZG/n/ocisateam/b/images/o/wildfly-to-oci.zip)
...
1. To check status of the initialization, you can check if the `JBoss/WildFly-to-oci_oracledbinit_1` container has finished running by running:
...
3. You should find two files `id_rsa` and `id_rsa.pub` inside the folder `./wildfly-to-oci/ssh/` on your local machine, and under `~/.ssh/` inside the containers
