...
## **Summary**
This completes Lab 1. You now know how to REST enable database objects include all of the necessary handlers. [Click here to navigate to Lab 2](?lab=lab-2-defining-web-sources).
