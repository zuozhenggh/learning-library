...
## **Task $1: 1** - Changing the Cards Region Style
...
## **Task $1: 2** - Enhancing Projects Page
...
## **Task $1: 4** - Link to Projects Page
...
## **Task $1: 5** - Update How Items are Displayed
...
## **Task $1: 6** - Improve the Completed Date
