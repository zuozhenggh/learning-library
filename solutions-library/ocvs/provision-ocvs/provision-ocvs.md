...
## Task 2: Configure connectivity to the internet through NAT Gateway
...
## Task 3: Configure connectivity to Oracle Services Network
...
## Task 4: Create a Public Subnet to host the Bastion server
...
## Task 5: Create a bastion host to access your SDDC
...
## Task 6: Create an Internet Gateway
...
## Task 7: Attach the Internet Gateway to the public subnet
...
## Task 8: Update security list to allow Remote Desktop connection
...
## Task 9: Configure Connectivity from VMWare private subnet to our public subnet
...
## Task 10: Access the SDDC using the Bastion
