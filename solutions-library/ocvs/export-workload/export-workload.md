...
## Task 1: Download VMware Workstation and Import Ubuntu Instance
...
## Task 2: Install and Setup LAMP (Linux, Apache, MySQL, PHP) & SSH
...
## Task 3: Setup OSCommerce Application
...
## Task 4: Configure osCommerce for End User
...
## Task 5: Export OVF File from VMWare Workstation to Object Storage
