...
12. After creating and saving calculation scripts, you use the Jobs page to execute them and perform the calculations on data loaded in your cube.

13.	Create your calculation script, or upload an existing calculation script.

14.	In Essbase, click Jobs.

15.	On the Jobs page, click New Job and select Run Calculation.

	![](./images/image14_87.png "")

16.	On the Run Calculation dialog box, select the application - DynamicCorp and cube – Sales.

17.	Select the script – CalcActual.

	![](./images/image14_88.png "")

18.	Click OK to start the calculation.

19.	Click Refresh to see the status of your calculation.
