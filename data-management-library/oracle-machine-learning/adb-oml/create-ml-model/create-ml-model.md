...
This lab uses a decision tree algorithm which is a classification technique. If these are new to you, here’s a [presentation](./files/Machine_Learning_Introduction.pdf) and a short [video](./files/Machine_Learning_Introduction.mp4) that explains machine learning, classification, and decision trees at a high level. 
