...
In this lab, you will create and configure a Standalone and  HeatWave DB Systems. 
...
- Create all two MySQL Database instances 
- Load sample data (airportdb) into the HeatWave BD system
...
## Task 2: Create a MySQL DB System - HeatWave  with sample data (airportdb)
