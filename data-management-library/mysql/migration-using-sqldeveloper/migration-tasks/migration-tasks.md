...
## Task 3: Load MySQL JDBC Driver and Source Connection
  ...
  **From Doc: 3.2.4.3 Before Migrating From MySQL**
  ...
  Once you attach the jar file as shown in the above screen-shot, you will see MySQL option, in the database type, other than Oracle. Here's how you make MySQL connection make. 
