...
## Introduction
This lab shows you how to create a compute instance and virtual cloud network (VCN) by using a prebuilt terraform script in Resource Manager. In future labs, you access your compute instance using Oracle Cloud Infrastructure (OCI) Cloud Shell, install Oracle Database 19c on it, and try out many of the Oracle Database 19c new features.
...
- **Cloud Shell** provides access to a free Linux shell (within monthly tenancy limits), providing you a convenient way to access your compute instance.

To learn more about OCI Resource Manager, preview the video below.
...
- Set up a stack in Resource Manager
- Use Resource Manager to quickly set up a compute instance and VCN
...
- You generated a public key and a private key. If not, please see [Lab 1: Generate SSH Keys](?lab=lab-1-generate-ssh-keys---cloud-shell).


## **STEP 1**: Set up a stack in Resource Manager

In this step, you download a Terraform script that you can run with Resource Manager to build your environment. If you already have a VCN created, skip this step and proceed to *STEP 3*.

1.  Click [livelabs-db19ccompute-0812.zip](https://objectstorage.us-ashburn-1.oraclecloud.com/p/R_vJuMUIrsFofKYcTuJOsDiXl2xdSjHNQU7yjQPtnh4/n/c4u03/b/labfiles/o/livelabs-db19ccompute-0812.zip) and save it to your **Downloads** folder.

2.  Log in to your Oracle Cloud account.

3.  On the Home page, click **Create a Stack**.
  ![Create a stack](images/db19c-freetier-step1.png " ")

4.  Select **My Configuration**, choose the **.ZIP FILE** button, click the **Browse** link and select the zip file (livelabs-db19ccompute-0812.zip) that you downloaded. Click **Select**.

 ![](./images/zip-file.png " ")

5. Enter a name of your choice, for example, **livelabs19c**.  Click **Next**.
  ![Create a stack](images/workshop-001.png " ")

6. Accept the region and select your compartment.  Select an **availability domain** from the drop-down list.
  ![Create a stack](images/workshop-002.png " ")

7. Paste the SSH key that you created in the previous lab.
  ![Create a stack](images/workshop-003.png " ")

8. Scroll down and select the **VMStandard.E2.4**.  *Note: Make sure you select the 2.4 version.  It has enough memory to run the database 19c binaries.*
  ![Create a stack](images/workshop-004.png " ")

9. Accept the network and click **Next**.
