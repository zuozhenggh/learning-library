# Obtain a Compute Image with Oracle Database In-Memory 19c installed

## Introduction

Use Resource Manager in Oracle Cloud Infrastructure (OCI) to quickly deploy a compute instance with the private **In-Memory workshop** image from Oracle Cloud Marketplace. The image has Oracle Database 19c installed on it and noVNC, which provides an easy-to-use browser user interface. On the desktop, there are shortcuts to a terminal window, a Firefox browser, and a gedit text editor.
...
1. Download [19c-workshop-in-memory.zip](https://objectstorage.us-ashburn-1.oraclecloud.com/p/DetwWXTx-C1XGpxazq4qpaeKYKwy3OpTYktlHiErGo-5XsMRRc8XLSZRs9V-LZFH/n/oradbclouducm/b/LiveLabsBucket/o/19c-workshop-in-memory.zip) to a directory on your local computer. This ZIP file contains the terraform script that you use with Resource Manager.
...
4. In the **Stack Configuration** area, select **.Zip file**, click **Browse**, select the ZIP file that you just downloaded, and then click **Open**.
  ...
  ![Stack Information](images/stack-information-page-workshop-in-memory.png "Stack Information page")
...
1. In a browser, enter the URL to your `workshop-in-memory` compute instance.
...
- **Author**- Troy Anthony, Database Development
- **Contribution**- Jody Glover, Principal User Assistance Developer, Database Development
- **Last Updated By/Date** - Troy Anthony, Database team, July 23 2021
