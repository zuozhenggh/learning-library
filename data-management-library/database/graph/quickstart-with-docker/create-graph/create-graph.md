...
## Overview
In this lab you will create a graph from the database tables containing customer, account, purchase, and relationship data. 
...
### Checking if the graph was created
...
Now proceed to the next lab where you will load, query, and analyze the Customer 360 graph.
