...
This lab assumes you have already completed the [Register for Free Tier] (?lab=lab-1-register-for-free-tier) lab seen in the menu on the right.  In this lab you will be provisioning an Autonomous Database instance using the cloud console.
