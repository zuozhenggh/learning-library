...
- [Property Graphs - Manually deploy the Graph Server and Client kit](manually-deploy-and-use-on-compute/workshops/freetier/) on a compute instance and get started with property graphs:
...
- [Property Graphs - Deploy the Graph Server and Client **OCI Marketplace** image](deploy-oci-marketplace-image/workshops/freetier/) and get started with property graphs:  
