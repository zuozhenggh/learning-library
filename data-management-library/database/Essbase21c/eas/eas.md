...
7.	Click **Save** then **OK**, and then **Close**.
   ...
   NOTE: Once the application is EAS managed, you can only view the outline in web interface. All changes that you do in the application will be performed using EAS console.
