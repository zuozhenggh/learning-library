...
- Verify which predefined unified audit policies are implemented. Observe the three new predefined unified audit policies implemented in Oracle Database 21c.
