...
String oTERMINAL = "";
String oOLS_READ_LABEL = "";
String oOLS_WRITE_LABEL = "";
String oOLS_MAX_READ_LABEL = "";
String oOLS_MAX_WRITE_LABEL = "";
...
<html>
 ...
 System.out.println( sql );
		...
		+ "sa_session.read_label('OLS_DEMO_HR_APP') OLS_READ_LABEL , "
		+ "sa_session.write_label('OLS_DEMO_HR_APP') OLS_WRITE_LABEL , "
		+ "sa_session.max_read_label('OLS_DEMO_HR_APP') OLS_MAX_READ_LABEL , "
		+ "sa_session.max_write_label('OLS_DEMO_HR_APP') OLS_MAX_WRITE_LABEL "
		+ " from dual ";
...
oOLS_READ_LABEL = rs.getString( "OLS_READ_LABEL" ) != null ? rs.getString( "OLS_READ_LABEL" ) : "";		
oOLS_WRITE_LABEL = rs.getString( "OLS_WRITE_LABEL" ) != null ? rs.getString( "OLS_WRITE_LABEL" ) : "";
oOLS_MAX_READ_LABEL = rs.getString( "OLS_MAX_READ_LABEL" ) != null ? rs.getString( "OLS_MAX_READ_LABEL" ) : "";		
oOLS_MAX_WRITE_LABEL = rs.getString( "OLS_MAX_WRITE_LABEL" ) != null ? rs.getString( "OLS_MAX_WRITE_LABEL" ) : "";
					%>	
					<%
					/*
				...
				%>
						...
						<tr><td>TERMINAL</td><td><%= oTERMINAL %></td></tr>
                                                <tr><td colspan=2><b> Label Security Context Data </b></td></tr>
					<tr><td>OLS_READ_LABEL</td><td><%= oOLS_READ_LABEL %></td></tr>
					<tr><td>OLS_WRITE_LABEL</td><td><%= oOLS_WRITE_LABEL %></td></tr>
					<tr><td>OLS_MAX_READ_LABEL</td><td><%= oOLS_MAX_READ_LABEL %></td></tr>
					<tr><td>OLS_MAX_WRITE_LABEL</td><td><%= oOLS_MAX_WRITE_LABEL %></td></tr>
					</table>
				</div>
			</div>
			<div id="footer">
