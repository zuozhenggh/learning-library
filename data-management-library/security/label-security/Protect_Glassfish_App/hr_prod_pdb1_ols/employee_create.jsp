...
<html>
     ...
     <form name="employee_create" method="post" action="controller.jsp" onsubmit="return checkEmployeeForm( this );">
      ...
      <div id="tabidentity" class="tabbertab" style="overflow: auto;">
       ...
       <table cellpadding="3" cellspacing="2" border="0">
        ...
        <tr><th>First Name<span style="color:red;">*</span></th><td><input type="text" name="firstname" size="35" value=""/></td></tr>
        <tr><th>Last Name<span style="color:red;">*</span></th><td><input type="text" name="lastname"  size="35"value=""/></td></tr>
         <tr><th>DOB<span style="color:red;">*</span></th>
          <td>
           <script language="javascript">
            var cal1x = new CalendarPopup("testdiv1");
            cal1x.showNavigationDropdowns();
           </script>
           <input type="text" name="dob" value="" readonly="readonly" style="color: #666;"/><a href="#" onclick="cal1x.select(document.forms[0].dob,'anchor0x','yyyy-MM-dd'); return false;" TITLE="cal1x.select(document.forms[0].dob,'anchor0x','yyyy-MM-dd'); return false;" NAME="anchor0x" ID="anchor0x"><img src="images/icon_calendar.gif" width="16" height="16" border="0" align="top"/></a><a href="#" onclick="document.forms[0].dob.value = '';"><img src="images/icon_delete.gif" width="16" height="16" border="0" align="top"/></a>
          </td>
         </tr>
 
        <tr><th>SSN</th><td><input type="text" name="ssn" size="15" value=""/></td></tr>
        <tr><th>SIN</th><td><input type="text" name="sin" size="15" value=""/></td></tr>
        <tr><th>NINO</th><td><input type="text" name="nino" size="15" value=""/></td></tr>
        <tr><th>Address 1<span style="color:red;">*</span></th><td><input type="text" name="address_1" size="35" value=""/></td></tr>
        <tr><th>Address 2</th><td><input type="text" name="address_2" size="35" value=""/></td></tr>
        <tr><th>Country</th><td><input type="text" name="country" size="5" value=""/></td></tr>
        <tr><th>Postal Code</th><td><input type="text" name="postal_code" size="15" value=""/></td></tr>
        <tr><th>Email</th><td><input type="text" name="email" size="45" value=""/></td></tr>
       ...
       <div id="tabsupdata" class="tabbertab" style="overflow: auto;">
        <h2>Supplemental Data</h2>
        <table cellpadding="3" cellspacing="2" border="0">
        <tr><th>Member ID</th><td><input type="text" name="member_id" size="20" value=""/></td></tr>
        <tr><th>Last Insurance Claim</th><td><input type="text" name="member_id" size="45" value=""/></td></tr>
        <tr><th>Bonus Amount</th><td><input type="text" name="bonus_amount" value=""/></td></tr>
        <tr><th>Payment Account #</th><td><input type="text" name="payment_acct_no" size="20" value=""/></td></tr>
        <tr><th>Routing Number</th><td><input type="text" name="routing_number" size="15" value=""/></td></tr>
        </table>
       </div>
 ...
 System.out.println( sql );
         ...
         <tr><th>Cost Center<span style="color:red;">*</span></th>
          <td>
           <select name="costcenter">
            ...
            <option value="102">102 - Cost Center 102</option>
            <option value="103">103 - Cost Center 103</option>
            <option value="104">104 - Cost Center 104</option>
           </select>
          </td>
         </tr>
         <tr>
       ...
       <!-- div id="tabcommunication" class="tabbertab" style="overflow: auto;">
        <h2>Communication</h2>
        <table cellpadding="3" cellspacing="2" border="0">
         <tr><th>Mobile Phone Number</th><td><input type="text" name="phonemobile" size="15" value=""/></td></tr>
         <tr><th>Fix Phone Number</th><td><input type="text" name="phonefix" size="15" value=""/></td></tr>
         <tr><th>Facsimile Telephone Number</th><td><input type="text" name="phonefax" size="15" value=""/></td></tr>
        </table>
       </div -->
      </div>
