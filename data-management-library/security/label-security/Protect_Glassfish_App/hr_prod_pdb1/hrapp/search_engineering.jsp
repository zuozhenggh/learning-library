...
String oFilterOrganization 	= request.getParameter( "organization" )	!= null ? (String) request.getParameter( "organization" )	: "";
						...
						<table cellpadding="3" cellspacing="2" border="0">
							...
							<tr><th>Employee Type</th>
								<td>
									<select name="emptype">
										<option value="">-- Choose a value --</option>
										<option value="Full-Time Employee" <% if ( oFilterEmpType.equals( "Full-Time Employee" ) ) out.print( "selected=\"selected\"" ); %>>Full-Time Employee</option>
										<option value="Part-Time Employee" <% if ( oFilterEmpType.equals( "Part-Time Employee" ) ) out.print( "selected=\"selected\"" ); %>>Part-Time Employee</option>
									</select>
								</td>
							...
							<tr>
								...
								<th>Organization</th><td><input type="text" name="organization" value="<%= oFilterOrganization %>"/></td>
							</tr>
							<!-- tr>
						...
						try
						{
							...
							Connection conn = DriverManager.getConnection( oJDBCURL, oJDBCUser, oJDBCPassword );
								...
								String oQuery = "select a.USERID, a.FIRSTNAME, a.LASTNAME, a.EMAIL, a.PHONEMOBILE, a.PHONEFIX, a.PHONEFAX, "
									+ "a.EMPTYPE, a.POSITION, a.ISMANAGER, a.MANAGERID, a.DEPARTMENT, a.ORGANIZATION, a.STARTDATE, a.ENDDATE, a.ACTIVE, "
								...
								if ( !oFilterOrganization.equals( "" ) )	{ oQuery += "and upper(a.ORGANIZATION) like '" + oFilterOrganization.toUpperCase() + "%' "; }
								...
								while (rs.next())
								{
									...
									String oOrganization = rs.getString("ORGANIZATION") != null ? rs.getString("ORGANIZATION") : "";
