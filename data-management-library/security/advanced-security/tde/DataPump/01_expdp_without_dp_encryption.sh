...
echo "By default, Data Pump Export creates an unencrypted dump of the data."
echo

expdp masking_admin/Oracle123@pdb1 schemas=EMPLOYEESEARCH_PROD DUMPFILE=empsearch_prod.dmp REUSE_DUMPFILES=YES
