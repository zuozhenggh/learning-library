...
echo "We will specify AES256 as the algorithm to use to encrypt the data."
echo

expdp masking_admin/Oracle123@pdb1 schemas=EMPLOYEESEARCH_PROD DUMPFILE=empsearch_prod.dmp REUSE_DUMPFILES=YES ENCRYPTION=ALL ENCRYPTION_ALGORITHM=AES256
