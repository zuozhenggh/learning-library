...
#
# Script: When_Complete_with_OAS_-_Stop_Infrastructure_Before_Moving_On.sh
#

# generate a log file for our script output
rm -f Stop_and_Reset_Infrastructure.out
exec > >(tee -a Stop_and_Reset_Infrastructure.out) 2>&1

# Script Dir
SCRIPT_DIR=$DBSEC_HOME/workshops/dbsec/redaction_scripts

. $DBSEC_HOME/scripts/cdb.env
...
# Stop Database
$DBSEC_HOME/scripts/stop_cdb.sh
