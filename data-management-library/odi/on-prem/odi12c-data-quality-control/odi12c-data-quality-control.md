<<<<<<< Updated upstream:data-management-library/odi/on-prem/odi12c-data-quality-control/odi12c-data-quality-control.md
...
Estimated Lab time : 30 minutejjis
...
1. Creating an age constraint consists of adding a data validity condition on a column. To create the age constraint:
...
Now that the static controls have been run on the source data, you are ready to move on to the next lab.
...
>>>>>>> Stashed changes:data-management-library/odi/odi_basic/odi12c-data-quality-control/odi12c-data-quality-control.md
