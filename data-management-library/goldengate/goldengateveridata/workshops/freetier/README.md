# Welcome to the Getting Started with Oracle GoldenGate Veridata Hands-on Workshop!

The **Getting Started with Oracle Big Data Service (BDS) workshop** is a series of step-by-step labs that guide you through the process of installing and configuring Oracle GoldenGate Veridata. You'll also explore with creating multiple domains, using various Veridata tools and utilities, such as the Import, Export, and Parameter Processing for GoldenGate (VGPP).
