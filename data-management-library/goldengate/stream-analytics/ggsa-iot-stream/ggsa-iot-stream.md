...
3. Click on the *ErrorStats* stage and Pause the stream.  The is a Guery-Group Stream  stage where we like to get some statistics on number of malfunctioning machines by description and also by what city they occur in.
