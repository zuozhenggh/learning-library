...
public class UpdateCallingCircleProcess extends CallingCircleProcess {

    private static final Logger logger = Logger.getLogger(UpdateCallingCircleProcess.class.getName());
    private static String dataFile = "updccprocess.txt";
    private static ArrayList transactionParams = null;
    private static int tpPointer = 0;
    private static Object lock = new Object();

    public UpdateCallingCircleProcess() {
    }

    public void init(Map params) throws SwingBenchException {
        String fileName = null;
        setId(UPDATE_CC_PROCESS);
            ...
            synchronized (lock) {
                if (transactionParams == null) {
                    ...
                    try {
                        ...
                        if (fileName == null) {
                            fileName = (String)params.get(Constants.CCUPDATEPROCESSFILELOC);
                        ...
                        br.close();
                        logger.fine("Loaded UpdateCallingCircleProcess() data into memory, transactionParams[] count =" + transactionParams.size());
                        ...
                        SwingBenchException sbe = new SwingBenchException("An Unexpected error occured in init() of UpdateCallingCircleProcess, see the following message : " + e.getMessage());
                        sbe.setSeverity(SwingBenchException.UNRECOVERABLEERROR);
                        throw sbe;
                    }
                }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            ...
            if (!((String)parameters.get(0)).equals("Get")) {
