...
public class StoredProcedure6 extends DatabaseTransaction {
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            try {
                CallableStatement cs = connection.prepareCall("{? = call swingbench.storedprocedure6(?,?)}");
                ...
                // Oddly the array is an array of BigDecimals. Expected int[]. Need to find a way to stop this being required.
