...
public class StoredProcedure3 extends DatabaseTransaction {
    public StoredProcedure3() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        int queryTimeOut = ((Integer) params.get(SwingBenchTask.QUERY_TIMEOUT)).intValue();
        ...
        try {
            ...
            try {
                CallableStatement cs = connection.prepareCall("{? = call swingbench.storedprocedure3(?,?)}");
