...
public class StoredProcedure4 extends DatabaseTransaction {
    public StoredProcedure4() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            ...
            try {
                CallableStatement cs = connection.prepareCall("{? = call swingbench.storedprocedure4(?,?)}");
