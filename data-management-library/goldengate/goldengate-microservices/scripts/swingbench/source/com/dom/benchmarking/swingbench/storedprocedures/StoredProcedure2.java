...
public class StoredProcedure2 extends DatabaseTransaction {
    public StoredProcedure2() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            ...
            try {
                CallableStatement cs = connection.prepareCall("{? = call swingbench.storedprocedure2(?,?)}");
