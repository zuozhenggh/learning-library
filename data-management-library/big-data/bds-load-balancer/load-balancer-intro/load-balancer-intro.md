...
(If you want to create a load balancer for a highly-available (HA) cluster, see the [Use a Load Balancer to Access Services on Big Data Service (HA Cluster)](https://apexapps.oracle.com/pls/apex/dbpm/r/livelabs/view-workshop?wid=810) workshop.)
