...
For the fastest data loading experience Oracle recommends uploading the source files to a cloud-based object store, such as Oracle Cloud Infrastructure Object Storage, before loading the data into your Autonomous Data Warehouse database.
...
-   Learn how to use SQL Developer Web to load data into an ADW table
...
In Part 1, you will create one ADW table, CHANNELS_LOCAL, and load it with sample data from your local file system. In Part 2, you will create several ADW tables and load them with sample data that you stage to an OCI Object Store.

## Part 1: Download Sample Data to local computer and load an ADW table
...
#### **STEP 2: Create CHANNELS_LOCAL Table in ADW using SQL Developer Web**

-   In your ADW database's details page, click the **Tools** tab. Click **Open SQL Developer Web**.
...
## Part 2: Create the target tables to load from an OCI Object Store

In Part 1, you created an ADW table and loaded it with sample data from your local file system. Now in Part 2, you will create several ADW tables and load them with sample data that you stage to an OCI Object Store.

#### **STEP 4: Download the Sample Data Files to Your Local Computer**
...
## Part 4:  Load data from the Object Store using DBMS_CLOUD
...
-   Connected as your user in SQL Developer Web, copy and paste <a href="./scripts/300/load_data.txt" target="\_blank">this code snippet</a> to a SQL Developer Web  worksheet. This script uses the **copy\_data** procedure of the **DBMS\_CLOUD** package to copy the data in the source files to the target tables you created before.
    ...
    ![](./images/300/run_data_loading_script_in_sql_dev_web.jpg " ")
