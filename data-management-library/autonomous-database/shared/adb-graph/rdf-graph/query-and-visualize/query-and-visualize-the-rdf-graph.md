...
1. Execute the following:
    ...
    <span class="oj-navigationlist-item-icon" aria-label="RunParagraph" role="img" title="RunParagraph"> <span class="fa fa-play" data-bind="css: item.data.icon.icon"></span> </span>.

    To create an RDF paragraph, mouse over the bottom of an existing paragraph and click the Add RDF Paragraph symbol
    <span class="oj-navigationlist-item-icon" aria-label="RDFGraph" role="img" title="RDFGraph"> <span class="fa fa-rotate-270 fa-network-triangle fa-1x" data-bind="css: item.data.icon.icon"></span> </span>.</copy>
    ```
    This screenshot shows how your output should look:

    ![Shows how to create and RDF paragraph](./images/running-md-paragraph.png)
...
**Section 2: Example Query 2: Using a SPARQL DESCRIBE WHERE Query**

Query 17 uses the `DESCRIBE WHERE` form to describe the director of Toy Story.
...
**Section 3:  Example Query 3: Using Dataset Descriptions in a SPARQL Query**
...
**Section 4: Example Query 4: Using OPTIONAL Clause in a SPARQL Query**
...
**Section 5: Example Query 5: Using Subqueries in a SPARQL Query**
...
**Section 6: Example Query 6: Using a SPARQL CONSTRUCT Query**
...
**Section 7: Example Query 7: Using Property Paths in a SPARQL Query**
...
**Section 8: Example Query 8: Using a Property Path Syntax in a SPARQL Query**

Query 8 uses `|` property path syntax to express the query more concisely. Note that this query is the same as Query 9.
...
**Section 9: Example Query 9: Using a SPARQL ASK Query**
...
**Section 10:  Example Query 16: Using a SPARQL DESCRIBE Query**
...
**Section 1:  Example Query 1: Executing a Concise SPARQL Query Using Shortcuts**
...
**Section 2: Example Query 2: Using Grouping and Aggregation in a SPARQL Query**
...
**Section 3: Example Query 3: Using LIMIT Clause in a SPARQL Query**
...
**Section 4:  Example Query 4: Using Class Membership in a SPARQL Query**
...
**Section 5:  Exammple Query 5: Using FILTER Clause in a SPARQL Query**
...
**Section 6: Example Query 6: Using UNION Clause in a SPARQL Query**
...
**Section 7: Example Query 7: Using Negation in a SPARQL Query**
