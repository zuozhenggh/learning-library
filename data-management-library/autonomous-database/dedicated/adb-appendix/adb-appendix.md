...
### Task 1: Locate the SCAN hostname of your AEI
...
### Task 2: Deploy and ssh into your developer client VM
...
### Task 3: Query your VCN's DNS service to locate IP address of AEI Cluster
