...
Then add the connection for the data asset. Create json_connection and select Pre-Authenticated Request for Type and put in the Pre-Authenticated Request URL.
...
![Create Data Asset](./images/genre_json.png " ")
