...
| **Host Credentials**            | Login as opc user using your private key (as described in *connecting to an instance* section of FAQ) \nLogin to root if needed: sudo –s (from opc user) \nLogin to oracle if needed: sudo su – oracle                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
