...
- Your ATP database is registered with Oracle Data Safe and sample data is loaded into it. If not, see [Register an Autonomous Database](?lab=register-autonomous-database).
