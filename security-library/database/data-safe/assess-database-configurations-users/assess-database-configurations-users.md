...
Security Assessment also lets you monitor security drift on your target databases. By setting a baseline Comprehensive Assessment report, and comparing it to another report, you can generate a Comparison report.

Run Security Assessment and User Assessment jobs in Oracle Data Safe to assess the configuration and users in your Autonomous Transaction Processing (ATP) database. Generate a Comparison Report using the auto-generated Comprehensive Report as the baseline report.
...
- Your environment is prepared. If not, see [Prepare Your Environment](?lab=prepare-environment). It's important that your ATP database is registered with Oracle Data Safe, you have enabled the Activity Auditing, User Assessment, and Security Assessment features on your database, and you have the appropriate privileges in Oracle Data Safe to use the Activity Auditing, User Assessment, and Security Assessment features with your database.
