...
This workshop requires an Oracle Cloud account. As a result of registering for LiveLabs, you will receive an email with instructions for signing in to the Oracle Cloud Infrastructure Console.

For this workshop, you are provided with the following:
