...
Start by reviewing the predefined alert policies in Oracle Data Safe, and then provision two of them. Review the alerts generated by the policy and close an alert. Lastly, create a custom alerts report and download it as a PDF.
