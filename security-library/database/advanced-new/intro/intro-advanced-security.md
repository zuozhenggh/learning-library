...
In this mini-lab, you will learn how to use the Oracle Advanced Security Option features (**Oracle Transparent Data Encryption** (TDE) and **Oracle Data Redaction**).
